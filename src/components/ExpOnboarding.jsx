...
// A card can name its own image; otherwise fall back to a seeded placeholder.
function photo(card) {
  if (card && card.img) return card.img
  return `https://picsum.photos/seed/vitalist-${photoSeed(card)}/900/1200`
}
