...
const SW_SLIDES = [
  {
    ...
    body: 'Dermatologists say the single most useful thing a patient can bring is a log of symptoms over time. Your SkInsight360 summary does this automatically.',
...
const STORIES = [
  ...
  },
  {
    ...
    takeaway: 'Your tracking data tells a story. Share your SkInsight360 summary.', takeawaySub: 'Your 21-day summary is ready to share',
    ...
    <main className="main learn-page prepare-page">
      ...
      <div className="pp-section">
        ...
        <div className="pp-ai-bar">
          <div className="pp-ai-label"><span className="pp-ai-dot" />SkInsight360 AI · Visit prep mode</div>
