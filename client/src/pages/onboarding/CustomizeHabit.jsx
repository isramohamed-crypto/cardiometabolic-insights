...
// how much to start with (tier), when they'll do it (stacked onto an
// existing moment, or an exact time), and whether to get reminded.
function CustomizeHabit({ habit, suggestedTierIndex, onBack, onSave }) {
