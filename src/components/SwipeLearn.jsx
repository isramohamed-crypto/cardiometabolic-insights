    ...
    <>
      <section className="swipe-learn">
        ...
        {phase === 'next2' ? (
          ...
          <div className="swipe-learn__wrap">
            <div className="vwm-scroll-card vwm-scroll-card--completing">
              <div className="swipe-learn__complete-overlay">
                <div className="swipe-learn__complete-check">✓</div>
                <p className="swipe-learn__complete-label">Activity complete</p>
              </div>
          ...
          /* phase === 'cards' (default) — Verywell Mind scroll viewer */
          <div className="swipe-learn__wrap">
            <div className="vwm-scroll-card">
              <div className="vwm-scroll-track" aria-label="The stress-skin connection — Verywell Mind">
                {[0, 1, 2, 3, 4, 5].map(i => (
                  <div key={i} className={`vwm-scroll-panel vwm-scroll-panel--${i}`} role="img" aria-label={`Panel ${i + 1} of 6`} />
                ))}
              </div>
            </div>
