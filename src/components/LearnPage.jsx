...
const TYPE_COLORS = {
  ...
  'Interactive':      { color: '#0053E2', bg: 'rgba(0,83,226,0.1)' },
  'Quiz':             { color: '#0053E2', bg: 'rgba(0,83,226,0.1)' },
  'Step-by-step':     { color: '#FF8C2F', bg: 'rgba(246,76,34,0.1)' },
  'Patient story':    { color: '#FF8C2F', bg: 'rgba(246,76,34,0.1)' },
  'Expert Q&A':       { color: '#1BBC3C', bg: 'rgba(27,188,60,0.1)' },
  'Micro-challenge':  { color: '#00B9E2', bg: 'rgba(0,185,226,0.15)' },
  'Poll':             { color: '#FF8C2F', bg: 'rgba(246,76,34,0.1)' },
  'Tap to learn':     { color: '#0053E2', bg: 'rgba(0,83,226,0.1)' },
  'Article':          { color: '#1BBC3C', bg: 'rgba(27,188,60,0.1)' },
}
...
const JOURNEYS = [
  ...
  },
  {
    ...
    activities: [
      ...
      { type: 'Micro-challenge', icon: '🌬️', name: '3-minute breathing reset',                               meta: 'Try now · 3 min',  done: true },
      { type: 'Expert Q&A',      icon: '🎬', name: 'Ask the expert: how lifestyle factors impact eczema',    meta: '2:30 · Video',     done: true },
