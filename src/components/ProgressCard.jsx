...
const metrics = [
  { label: 'Inflammation', width: '72%', delta: '↑ 18%', up: true,  color: 'var(--color-teal)' },
  { label: 'Sleep quality', width: '58%', delta: '↑ 9%', up: true,  color: 'var(--color-sage)' },
  { label: 'Activity',      width: '45%', delta: '→ 0%', up: false, color: 'var(--color-warm)' },
]
        ...
        {metrics.map(m => (
          <li key={m.label} className="progress-list__item">
            ...
            <div className="progress-list__bar-wrap">
              <div className="progress-list__bar" style={{ width: m.width, background: m.color }} />
            </div>
